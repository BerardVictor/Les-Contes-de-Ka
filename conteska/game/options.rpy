...
define config.name = _("Les Contes de Ka : l'Ére des Zémis")
...
define config.version = "Version 0.1"
...
define build.directory_name = "conteska"
define build.name = "conteska"
...
define config.save_directory = "TitleScreen-1559124407"
