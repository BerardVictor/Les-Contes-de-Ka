...
style button:
    ...
    hover_sound "audio/sound01.ogg"
    activate_sound "audio/sound02.ogg"
...
#                    idle_foreground Text(i.caption , xalign=0.5, yalign=1.0, yoffset=0)
#                    hover_foreground Text(i.caption , xalign=0.5, yalign=1.0, yoffset=0)
...
screen navigation():
    ...
    vbox:
        ...
        if renpy.variant("pc"):
            ...
            ## mobiles.
            textbutton _("Commandes") action ShowMenu("help")
...
screen help():
    ...
    use game_menu(_("Commandes"), scroll="viewport"):
...
#        textbutton
    ...
    imagebutton :
        action Return()
        idle "images/profil.png"
        hover "images/profil.png"
        xalign 0.993
        yalign 0.06
